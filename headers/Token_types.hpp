...
namespace Token {
    ...
    enum class Operator {
        ...
        TERNARY_IF, TERNARY_ELSE, INCREMENT, DECREMENT,
    };
    ...
    enum class Keyword {
        ...
        THREAD_LOCAL, SYNCHRONIZED, DYNAMIC_CAST, STATIC_ASSERT,
        ATOMIC_COMMIT, ATOMIC_CANCEL, ATOMIC_NOEXCEPT, REINTERPRET_CAST, 
    };
